...
import { visibleCartLineWeight, type OptionalCartLineWeight } from '@/lib/cartLineWeight';
...
interface CartItem {
    ...
    /** Optional; display only when present. Null/blank invents nothing. */
    weight?: OptionalCartLineWeight;
}
...
const CartItemRow = ({ item, updateQuantity, removeItem, toggleWishlist, isWishlisted }: {
    ...
    const weight = visibleCartLineWeight(item);
    ...
    return (
        <div className={styles.cartItem}>
            ...
            <div className={styles.itemInfo}>
                ...
                {weight ? <p className={styles.lineWeight}>{weight}</p> : null}
