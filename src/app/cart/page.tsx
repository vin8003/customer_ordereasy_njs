...
import { visibleCartLineBundleId, type OptionalCartLineBundleId } from '@/lib/cartLineBundleId';
...
interface CartItem {
    ...
    bundle_id?: OptionalCartLineBundleId;
}
...
const CartItemRow = ({ item, updateQuantity, removeItem, toggleWishlist, isWishlisted }: {
    ...
    const bundleId = visibleCartLineBundleId(item);
    ...
    return (
        <div className={styles.cartItem}>
            ...
            <div className={styles.itemInfo}>
                ...
                {bundleId ? <p className={styles.bundleId}>{bundleId}</p> : null}
