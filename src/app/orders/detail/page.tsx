...
import { getVisibleOrderCashbackAmount } from '@/lib/orderCashbackAmount';
...
interface OrderDetail {
    ...
    cashback_amount?: OptionalMoneyAmount;
...
function OrderDetails() {
    ...
    const cashbackAmount = getVisibleOrderCashbackAmount(order);
