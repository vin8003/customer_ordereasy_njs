...
function OrderDetails() {
    ...
    const visibleGiftMessage = getVisibleGiftMessage(order);
    ...
    return (
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                ...
                {visibleGiftMessage && (
                    <section className={styles.section}>
                        <h3 className="font-bold mb-2 text-sm text-gray-500 uppercase">Gift Message</h3>
                        <div className={styles.instructionsBox}>{visibleGiftMessage}</div>
                    </section>
                )}
