...
import {
    formatVisiblePackQty,
    type OptionalPackQty,
} from '@/lib/productDetailPackQty';
import styles from './ProductDetail.module.css';

interface Product {
    id: number;
    name: string;
    pack_qty?: OptionalPackQty;
    description: string;
...
function ProductDetail() {
    ...
    const visiblePackQty = formatVisiblePackQty(product.pack_qty);
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.details}>
                ...
                {visiblePackQty ? (
                    <p className={styles.packQty}>Pack qty {visiblePackQty}</p>
                ) : null}
