...
import {
    formatVisibleOriginCountry,
    type OptionalOriginCountry,
} from '@/lib/productDetailOriginCountry';
import styles from './ProductDetail.module.css';

interface Product {
    id: number;
    name: string;
    origin_country?: OptionalOriginCountry;
    description: string;
...
function ProductDetail() {
    ...
    const visibleOriginCountry = formatVisibleOriginCountry(product.origin_country);
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.details}>
                ...
                {visibleOriginCountry ? (
                    <p className={styles.originCountry}>{visibleOriginCountry}</p>
                ) : null}
