...
import {
    formatVisibleProductRating,
    type OptionalRating,
} from '@/lib/productDetailRating';
...
function ProductDetail() {
    ...
    const visibleRating = formatVisibleProductRating(product.rating);
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.details}>
                ...
                {visibleRating ? (
                    <p className={styles.rating}>★ {visibleRating}</p>
                ) : null}
